    ...
    fn deserialize_tl(buf: &mut TlBytes) -> TypeResult<Self> {
        ...
        match constructor_id {
            ...
            0x35154f1d => {
                ...
                Ok(Self::SignUpRequired { terms_of_service })
            }
...
mod tests {
    ...
    fn test_sent_code_new() {
        let code = SentCode::new(true, SentCodeType::Sms { length: 5 }, None, 60);
    ...
    fn test_sent_code_clone() {
        let code1 = SentCode::new(true, SentCodeType::Sms { length: 5 }, None, 60);
    ...
    fn test_sent_code_no_timeout() {
        let code = SentCode::new(true, SentCodeType::Sms { length: 5 }, None, 0);
